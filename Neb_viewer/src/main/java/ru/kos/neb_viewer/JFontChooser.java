...
public class JFontChooser extends JComponent
{
    ...
    private final JLabel jLabel1 = new JLabel("Test:");
    ...
    private void jTextKeyPressed(@SuppressWarnings("unused") java.awt.event.KeyEvent evt) {                                       
    ...
    protected JPanel getEditPanel()
    {
        if (editPanel == null)
        {
            ...
            editPanel.setPreferredSize(new Dimension(120, 130));
            jLabel1.setText("Text:");
            jLabel1.setHorizontalAlignment(JLabel.LEFT);
            jLabel1.setHorizontalTextPosition(JLabel.LEFT);            
            editPanel.add(jLabel1, BorderLayout.NORTH);
            
            JPanel textPanel = new JPanel();
            text.setColumns(10);
            text.setBorder(new LineBorder(new Color(0, 153, 0), 2));
            textPanel.add(text, BorderLayout.CENTER);
            editPanel.add(textPanel, BorderLayout.CENTER);
